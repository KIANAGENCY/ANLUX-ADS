...
export default function IntelligencePage() {
  ...
  return <div className="space-y-5">
    ...
    {result && <>
      <div className="grid gap-3 sm:grid-cols-3"><Stat label="Campañas evaluadas" value={campaigns.length}/><Stat label="Resultados verificados por Meta" value={verifiedResults.length === campaigns.length ? String(verifiedResults.reduce((sum, decision) => sum + decision.currentMetrics.results, 0)) : "Parciales"}/><Stat label="Acciones sugeridas para revisar" value={proposals.length}/></div>
